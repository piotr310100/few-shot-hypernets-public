...
def add_hn_args_to_parser(parser: ArgumentParser) -> ArgumentParser:
    ...
    fhypermaml_args.add_argument('--flow_temp_stop_val', default=0.1, type=float, help='final value of value scale for temperature and dkl')
    fhypermaml_args.add_argument('--flow_dkl_stop_val', default=1, type=float, help='final value of value scale for temperature and dkl')
    #fhypermaml_args.add_argument('--warmup_coef', default=1.2, type=float, help='flow_dkl_warmup_epochs / flow_temp_warmup_epochs coef')
    fhypermaml_args.add_argument('--flow_temp_scale', default=1e-24, type=float, help='initial value of scaling for temp')
    fhypermaml_args.add_argument('--flow_dkl_scale', default=1e-24, type=float, help='initial value of scaling for dkl loss')
    ...
    fhypermaml_args.add_argument('--flow_zero_warmup_epochs', default=0, type=int,help='num of epochs for flow using zeros as sample')
    ...
    fhypermaml_args.add_argument('--flow_dkl_warmup_epochs', default=50, type=int,help='num of epochs for flow using increasing dkl loss scaling')
    fhypermaml_args.add_argument('--flow_num_norm_warmup_epochs', default=0, type=int, help='num of epochs for flow norm loss')
