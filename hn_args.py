...
def add_hn_args_to_parser(parser: ArgumentParser) -> ArgumentParser:
    ...
    fhypermaml_args.add_argument('--flow_temp_start_val', default=1.0, type=float, help='initial value of scaling for temp')
    fhypermaml_args.add_argument('--flow_temp_strategy', default="None", choices=["Linear", "Exp", "None"], help="strategy for increasing sample temperature in flow")
    fhypermaml_args.add_argument('--flow_temp_start_epoch', default=600, type=int,help='number of epoch for temperature to start changing')
    fhypermaml_args.add_argument('--flow_temp_stop_epoch', default=1000, type=int,help='number of epoch for temperature to stop changing')
