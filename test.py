...
def single_test(params):
    ...
    elif params.method == 'hyper_maml' or params.method == 'bayes_hmaml' or params.method == 'fhyper_maml':
    ...
    eval_time = 0
    if params.method in ['maml', 'maml_approx', 'hyper_maml','bayes_hmaml', 'DKT','fhyper_maml'] + list(hypernet_types.keys()): #maml do not support testing with feature
